...
import com.example.mealpassapp.activities.FoodAllCommentsActivity;
import com.example.mealpassapp.R;
import com.example.mealpassapp.activities.ViewOrderResponseActivity;
...
//        super(context, R.layout.order_response_list, list);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView item = (TextView) status_list.findViewById(R.id.tvItem);
