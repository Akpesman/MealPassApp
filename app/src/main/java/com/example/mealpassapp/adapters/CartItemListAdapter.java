...
import com.example.mealpassapp.activities.CartItemDetailsActivity;
import com.example.mealpassapp.activities.CartItemsActivity;
     ...
     Picasso.with(mcontext).load(item.getSellerPic()).placeholder(R.drawable.loading).fit().centerCrop().into(holder.dealerPic);
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setMessage("Are you sure to remove item from cart?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbRef.removeValue();
                        Toast.makeText(mcontext, "Successfully removed from cart", Toast.LENGTH_SHORT).show();
                    }
