                ...
                if (task.isSuccessful()) {
                    for(UsersModel fbAdapter : usersList){
                        if(phoneNumber.equals(fbAdapter.getPhone())){
                            Toast.makeText(AuthenticationActivity.this, "Account existed", Toast.LENGTH_SHORT).show();
                            ...
                            switch (t) {
                                case 'U':
                                    ...
                                    break;
                                case 'F':
                                    Intent intent2 = new Intent(AuthenticationActivity.this, FoodSellerActivity.class);
                                    addUserdataToSharedPref();
