...
import com.example.mealpassapp.helpers.RegularExpressions;
...
public class AddFoodItemActivity extends BaseActivity {
    ...
    private Uri mImageUri = Uri.EMPTY ,resultUri = Uri.EMPTY;
    ImageView setImage ;
    ImageView addsPic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageUri = Uri.parse("android.resource://com.example.mealpassapp/" +R.drawable.meal_pass);
        resultUri = Uri.parse("android.resource://com.example.mealpassapp/" +R.drawable.meal_pass);
        ...
        ButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!RegularExpressions.validateItemName(itemName)){
