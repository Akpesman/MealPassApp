...
public class RegisterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageUri = Uri.parse("android.resource://com.example.mealpassapp/" +R.drawable.profile_icon);
        resultUri = Uri.parse("android.resource://com.example.mealpassapp/" +R.drawable.profile_icon);
